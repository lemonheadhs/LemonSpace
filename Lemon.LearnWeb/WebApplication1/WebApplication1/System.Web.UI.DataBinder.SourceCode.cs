namespace System.Web.UI
{
    ...
    public sealed class DataBinder
    {
        ...
        public static object GetDataItem(object container, out bool foundDataItem)
        {
            ...
            IDataItemContainer container2 = container as IDataItemContainer;  //尝试将控件转换成 IDataItemContainer接口类型
            if (container2 != null)// 转换成功，则必包含DataItem
            {
                foundDataItem = true;
                return container2.DataItem;
            }

            // 控件没有实现 IDataItemContainer接口，则通过反射查找控件是否包含"DataItem"属性
